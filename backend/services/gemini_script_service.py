...
(분위기에 [트렌드 힌트: ...]가 포함되어 있다면, 그 실존 인물/브랜드/작품을 Google 검색으로 파악하세요.
 - 캐릭터 description_en: 해당 인물의 **실제 외형**을 최대한 충실히 묘사 (체형, 얼굴형, 피부톤, 헤어, 의상 등 — 보는 사람이 바로 누구인지 알 수 있게)
...
- **[트렌드 힌트]가 있으면**: 해당 실존 인물의 **실제 얼굴/체형/헤어/의상**을 검색하여 description_en에 그대로 반영. 보는 사람이 "아 그 사람이다!"라고 즉시 알아볼 수 있어야 함. 이름만 바꾸고 외형은 실제와 최대한 동일하게
