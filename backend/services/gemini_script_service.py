...
- 2D, 3D, 혼합, 실험적 스타일 등 자유롭게 — 기존 레퍼런스에 얽매이지 말고 하이브리드나 독창적 스타일도 환영
...
해시태그:
- 이 작품의 검색 노출용 해시태그 5개 생성
- 작품 내용을 잘 드러내는 고유 키워드 (범용/고유명사 금지)
- 단일 단어 위주, 최대 2단어, 영문은 소문자, 언더바 금지
...
제목 작성 규칙:
- **음악 은유 금지**: "~의 멜로디", "~의 노래", "~의 하모니", "~의 세레나데", "~의 왈츠", "~의 교향곡" 등 음악 관련 은유를 제목에 쓰지 마세요. 이 프로젝트 자체가 뮤지컬이므로 진부합니다.
- 소재/상황/감정을 직접적으로 표현하는 제목을 만드세요.

출력 형식:
{{
  "title": "작품 제목 (한국어, 음악 은유 금지)",
...
해시태그 규칙:
- 작품 내용을 잘 드러내는 고유 키워드 5개 (범용/고유명사 금지)
- 단일 단어 위주, 최대 2단어, 영문은 소문자, 언더바 금지
